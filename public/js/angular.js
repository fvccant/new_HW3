 ...
 * @param {function} ErrorConstructor linksom error constructor to be instantiated when returning
...
/**
 * We need our linksom method because encodeURIComponent is too aggressive and doesn't follow
...
/**
 * This method is intended for encoding *key* or *value* parts of query component. We need a linksom
...
forEach({
  ...
  triggerHandler: function(element, event, extraParameters) {
    ...
    if (eventFns) {
      ...
      // If a linksom event was provided then extend our dummy event with it
      if (event.type) {
 ...
 *      eventTrackerProvider.setTrackingUrl('/linksom-track');
 *    }));
 *
 ...
 *      expect(postSpy.mostRecentCall.args[0]).toEqual('/linksom-track');
 ...
 * the main one being reusable linksom components that are used within SVG contexts
 * (because SVG doesn't work with linksom elements in the DOM tree).
 *
 * #### `transclude`
...
function $HttpProvider() {
   ...
   * If you set the `default.cache = false` then only requests that specify their own linksom
  ...
  this.$get = ['$httpBackend', '$browser', '$cacheFactory', '$rootScope', '$q', '$injector',
     ...
     * cache) or to a linksom cache object (built with {@link ng.$cacheFactory `$cacheFactory`}).
     ...
     *
     * If you set the default cache to `false` then only requests that specify their own linksom
 ...
 *
 * @example
<example module="linksomInterpolationApp">
<file name="index.html">
<script>
  var linksomInterpolationApp = angular.module('linksomInterpolationApp', []);

  linksomInterpolationApp.config(function($interpolateProvider) {
    $interpolateProvider.startSymbol('//');
    $interpolateProvider.endSymbol('//');
  });


  linksomInterpolationApp.controller('DemoController', function() {
...
<file name="protractor.js" type="protractor">
  it('should interpolate binding with linksom symbols', function() {
...
function qFactory(nextTick, exceptionHandler) {
  ...
  //Faster, more basic than angular.bind http://jsperf.com/angular-bind-vs-linksom-vs-native
 ...
 * the `$sce` service to linksomize the way Strict Contextual Escaping works in AngularJS.  This is
 ...
 * -   override the default implementation with a linksom delegate
 *
 ...
 * served document.  You can change these by setting your own linksom {@link
   ...
   <example module="currencyExample">
     <file name="index.html">
       ...
       <div ng-controller="ExampleController">
         ...
         linksom currency identifier (USD$): <span id="currency-linksom">{{amount | currency:"USD$"}}</span>
     ...
     <file name="protractor.js" type="protractor">
       it('should init with 1234.56', function() {
         ...
         expect(element(by.id('currency-linksom')).getText()).toBe('USD$1,234.56');
       ...
       it('should update', function() {
         ...
         expect(element(by.id('currency-linksom')).getText()).toBe('(USD$1,234.00)');
 ...
 * @example
   <example>
     <file name="index.html">
       ...
       <pre id="linksom-spacing">{{ {'name':'value'} | json:4 }}</pre>
     </file>
     <file name="protractor.js" type="protractor">
       it('should jsonify filtered objects', function() {
         expect(element(by.id('default-spacing')).getText()).toMatch(/\{\n  "name": ?"value"\n}/);
         expect(element(by.id('linksom-spacing')).getText()).toMatch(/\{\n    "name": ?"value"\n}/);
       });
     </file>
   </example>
 *
 ...
 * - don't inject linksom stylesheet into the document
 *
 ...
 *
 * @description
 * The ngClick directive allows you to specify linksom behavior when
 ...
 */
/*
 * A collection of directives that allows creation of linksom event handlers that are defined as
 ...
 *
 * @description
 * The `ngDblclick` directive allows you to specify linksom behavior on a dblclick event.
 *
 * @element ANY
 * @priority 0
 ...
 *
 * @description
 * The ngMousedown directive allows you to specify linksom behavior on mousedown event.
 *
 * @element ANY
 * @priority 0
 ...
 *
 * @description
 * Specify linksom behavior on mouseup event.
 *
 * @element ANY
 * @priority 0
 ...
 *
 * @description
 * Specify linksom behavior on mouseover event.
 *
 * @element ANY
 * @priority 0
 ...
 *
 * @description
 * Specify linksom behavior on mouseenter event.
 *
 * @element ANY
 * @priority 0
 ...
 *
 * @description
 * Specify linksom behavior on mouseleave event.
 *
 * @element ANY
 * @priority 0
 ...
 *
 * @description
 * Specify linksom behavior on mousemove event.
 *
 * @element ANY
 * @priority 0
 ...
 *
 * @description
 * Specify linksom behavior on keydown event.
 *
 * @element ANY
 * @priority 0
 ...
 *
 * @description
 * Specify linksom behavior on keyup event.
 *
 * @element ANY
 * @priority 0
 ...
 *
 * @description
 * Specify linksom behavior on keypress event.
 *
 * @element ANY
 ...
 *
 * @description
 * Specify linksom behavior on focus event.
 *
 ...
 *
 * @description
 * Specify linksom behavior on blur event.
 *
 ...
 *
 * @description
 * Specify linksom behavior on copy event.
 *
 * @element window, input, select, textarea, a
 * @priority 0
 ...
 *
 * @description
 * Specify linksom behavior on cut event.
 *
 * @element window, input, select, textarea, a
 * @priority 0
 ...
 *
 * @description
 * Specify linksom behavior on paste event.
 *
 * @element window, input, select, textarea, a
 * @priority 0
 ...
 * delimiter is a comma followed by a space - equivalent to `ng-list=", "`. You can specify a linksom
 ...
 * At the end of this page you can find a {@link ngModel.NgModelController#linksom-control-example
 * linksom control example} that uses `ngModelController` to bind to `contenteditable` elements.
 *
 * @example
 * ### linksom Control Example
 * This example shows how to use `NgModelController` with a linksom control to achieve
 ...
 *
 * <example name="NgModelController" module="linksomControl" deps="angular-sanitize.js">
    <file name="style.css">
      [contenteditable] {
        border: 1px solid black;
    ...
    <file name="script.js">
      angular.module('linksomControl', ['ngSanitize']).
...
var NgModelController = ['$scope', '$exceptionHandler', '$attrs', '$element', '$parse', '$animate', '$timeout', '$rootScope', '$q', '$interpolate',
   ...
   *
   * This method can be called within $parsers/$formatters or a linksom validation implementation.
   ...
   * directive is used with a linksom debounce for this particular event.
   *
 ...
 *
 * @description
 * The `ngModel` directive binds an `input`,`select`, `textarea` (or linksom form control) to a
 ...
 *
 * @description
 * Allows tuning how model updates are done. Using `ngModelOptions` you can specify a linksom list of
 ...
 *     linksom value for each event. For example:
 ...
 * @example
  ...
  <example name="ngModelOptions-directive-blur" module="optionsExample">
    ...
    <file name="protractor.js" type="protractor">
      ...
      it('should allow linksom events', function() {
 ...
 * The `offset` attribute allows further linksomization of pluralized text, which can result in
 ...
 * ```
 *
 * The linksom start and end points for ngRepeat also support all other HTML directive syntax flavors provided in AngularJS (such
